const int DATA = 11;// pin 12 của Arduino nối với pin DATA của 74HC595
const int CLOCK = 12;//pin 10 của Arduino nối với pin CLOCK của 74HC595
const int LATCH = 8;//pin 11 của Arduino nối với pin LATCH của 74HC595
